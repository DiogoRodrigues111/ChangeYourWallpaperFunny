...
// DreamWallpaper.cpp: define os comportamentos de classe para o aplicativo.
//
...
BEGIN_MESSAGE_MAP(CDreamWallpaperApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// construção de CDreamWallpaperApp

CDreamWallpaperApp::CDreamWallpaperApp()
{
...
// O único objeto de CDreamWallpaperApp

CDreamWallpaperApp theApp;


// inicialização de CDreamWallpaperApp

BOOL CDreamWallpaperApp::InitInstance()
{
